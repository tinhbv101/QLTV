    ...
    public partial class USTraSachGV : UserControl
    {
        ...
        private void btnTra_Click(object sender, EventArgs e)
        {
            ...
            if (hieu == 0)
            {
                ...
                if (sach.traSachALL(TextBox_MaPhieu.Text.Trim(), "GV001", TextBox_MaSach.Text.Trim()))
                {
            ...
            {
                if (sach.traSachUpdate(hieu, TextBox_MaPhieu.Text.Trim(), "GV001", TextBox_MaSach.Text.Trim()))
                {
                    MessageBox.Show("Trả thành công", "Trả sách", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
